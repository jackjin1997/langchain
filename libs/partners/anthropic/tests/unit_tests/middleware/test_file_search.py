...
class TestFilesystemGrepSearch:
    ...
    def test_grep_base_path_excludes_sibling_prefix(self) -> None:
        """Test grep requires a directory boundary after the base path."""
        middleware = StateFileSearchMiddleware()
        ...
        assert result == "/app/config.txt:1:service=web"
